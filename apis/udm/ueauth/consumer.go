...
func GetRgAuthData(cli sbi.ConsumerClient, ctx context.Context, params GetRgAuthDataParams) (rsp *models.RgAuthCtx, err error) {
...
func ConfirmAuth(cli sbi.ConsumerClient, ctx context.Context, supi string, body *models.AuthEvent) (headers map[string]string, rsp *models.AuthEvent, err error) {
...
func GenerateAv(cli sbi.ConsumerClient, ctx context.Context, params GenerateAvParams, body *models.HssAuthenticationInfoRequest) (rsp *models.HssAuthenticationInfoResult, err error) {
...
func DeleteAuth(cli sbi.ConsumerClient, ctx context.Context, params DeleteAuthParams, body *models.AuthEvent) (err error) {
...
// Path Params: supi
func GenerateGbaAv(cli sbi.ConsumerClient, ctx context.Context, supi string, body *models.GbaAuthenticationInfoRequest) (rsp *models.GbaAuthenticationInfoResult, err error) {
...
// Path Params: supiOrSuci
func GenerateProseAV(cli sbi.ConsumerClient, ctx context.Context, supiOrSuci string, body *models.ProSeAuthenticationInfoRequest) (rsp *models.ProSeAuthenticationInfoResult, err error) {
...
// Path Params: supiOrSuci
func GenerateAuthData(cli sbi.ConsumerClient, ctx context.Context, supiOrSuci string, body *models.AuthenticationInfoRequest) (rsp *models.AuthenticationInfoResult, err error) {
