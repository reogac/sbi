...
// Path Params: ueId
func Non3GppRegistration(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.AmfNon3GppAccessRegistration) (rsp *models.AmfNon3GppAccessRegistration, err error) {
...
func RetrieveSmfRegistration(cli sbi.ConsumerClient, ctx context.Context, params RetrieveSmfRegistrationParams) (rsp *models.SmfRegistration, err error) {
...
func Get3GppSmsfRegistration(cli sbi.ConsumerClient, ctx context.Context, params Get3GppSmsfRegistrationParams) (rsp *models.SmsfRegistration, err error) {
...
func SmfDeregistration(cli sbi.ConsumerClient, ctx context.Context, params SmfDeregistrationParams) (err error) {
...
func UpdateSmfRegistration(cli sbi.ConsumerClient, ctx context.Context, params UpdateSmfRegistrationParams, body *models.SmfRegistrationModification) (rsp *models.PatchResult, err error) {
...
func Registration(cli sbi.ConsumerClient, ctx context.Context, params RegistrationParams, body *models.SmfRegistration) (rsp *models.SmfRegistration, err error) {
...
func ThreeGppSmsfDeregistration(cli sbi.ConsumerClient, ctx context.Context, params ThreeGppSmsfDeregistrationParams) (err error) {
...
func Non3GppSmsfDeregistration(cli sbi.ConsumerClient, ctx context.Context, params Non3GppSmsfDeregistrationParams) (err error) {
...
// Path Params: ueId
func GetIpSmGwRegistration(cli sbi.ConsumerClient, ctx context.Context, ueId string) (rsp *models.IpSmGwRegistration, err error) {
...
func GetLocationInfo(cli sbi.ConsumerClient, ctx context.Context, params GetLocationInfoParams) (rsp *models.LocationInfo, err error) {
...
func GetRegistrations(cli sbi.ConsumerClient, ctx context.Context, params GetRegistrationsParams) (rsp *models.RegistrationDataSets, err error) {
...
// Path Params: ueId
func ThreeGppRegistration(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.Amf3GppAccessRegistration) (rsp *models.Amf3GppAccessRegistration, err error) {
...
// Path Params: ueId
func DeregAMF(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.AmfDeregInfo) (err error) {
...
func GetSmfRegistration(cli sbi.ConsumerClient, ctx context.Context, params GetSmfRegistrationParams) (rsp *models.SmfRegistrationInfo, err error) {
...
func ThreeGppSmsfRegistration(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.SmsfRegistration) (headers map[string]string, rsp *models.SmsfRegistration, err error) {
...
// Path: /:ueId/registrations/ip-sm-gw
// Path Params: ueId
func IpSmGwDeregistration(cli sbi.ConsumerClient, ctx context.Context, ueId string) (err error) {
...
func NwdafRegistration(cli sbi.ConsumerClient, ctx context.Context, params NwdafRegistrationParams, body *models.NwdafRegistration) (rsp *models.NwdafRegistration, err error) {
	...
	case 200:
		...
		if err = response.DecodeBody(rsp); err != nil {
			err = fmt.Errorf("Fail to decode NwdafRegistration: %+v", err)
		}
	case 204:
		return
	case 400, 403, 404, 500, 503:
...
func Get3GppRegistration(cli sbi.ConsumerClient, ctx context.Context, params Get3GppRegistrationParams) (rsp *models.Amf3GppAccessRegistration, err error) {
...
func UpdateNwdafRegistration(cli sbi.ConsumerClient, ctx context.Context, params UpdateNwdafRegistrationParams, body *models.NwdafRegistrationModification) (rsp *models.Schema, err error) {
...
func Update3GppRegistration(cli sbi.ConsumerClient, ctx context.Context, params Update3GppRegistrationParams, body *models.Amf3GppAccessRegistrationModification) (rsp *models.PatchResult, err error) {
...
func UpdateNon3GppRegistration(cli sbi.ConsumerClient, ctx context.Context, params UpdateNon3GppRegistrationParams, body *models.AmfNon3GppAccessRegistrationModification) (rsp *models.PatchResult, err error) {
...
// Path: /:ueId/registrations/ip-sm-gw
// Path Params: ueId
func IpSmGwRegistration(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.IpSmGwRegistration) (rsp *models.IpSmGwRegistration, err error) {
...
// Path: /restore-pcscf
// Path Params:
func TriggerPCSCFRestoration(cli sbi.ConsumerClient, ctx context.Context, body *models.TriggerRequest) (err error) {
...
func GetNwdafRegistration(cli sbi.ConsumerClient, ctx context.Context, params GetNwdafRegistrationParams) (rsp *[]models.NwdafRegistration, err error) {
...
// Path Params: ueId
func SendRoutingInfoSm(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.RoutingInfoSmRequest) (rsp *models.RoutingInfoSmResponse, err error) {
	...
	case 200:
		...
		if err = response.DecodeBody(rsp); err != nil {
			err = fmt.Errorf("Fail to decode RoutingInfoSmResponse: %+v", err)
		}
	case 400, 403, 404, 500, 503:
		prob := new(models.ProblemDetails)
		if err = response.DecodeBody(prob); err == nil {
...
func GetNon3GppRegistration(cli sbi.ConsumerClient, ctx context.Context, params GetNon3GppRegistrationParams) (rsp *models.AmfNon3GppAccessRegistration, err error) {
...
func GetNon3GppSmsfRegistration(cli sbi.ConsumerClient, ctx context.Context, params GetNon3GppSmsfRegistrationParams) (rsp *models.SmsfRegistration, err error) {
...
// Path Params: ueId
// Response headers: ETag
func Non3GppSmsfRegistration(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.SmsfRegistration) (headers map[string]string, rsp *models.SmsfRegistration, err error) {
...
func NwdafDeregistration(cli sbi.ConsumerClient, ctx context.Context, params NwdafDeregistrationParams) (err error) {
...
// Path Params: ueId
func PeiUpdate(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.PeiUpdateInfo) (err error) {
