...
// Path Params: ueId
func ReadAccessAndMobilityPolicyData(cli sbi.ConsumerClient, ctx context.Context, ueId string) (rsp *models.AmPolicyData, err error) {
...
// Path Params: ueId
func CreateOrReplaceUEPolicySet(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.UePolicySet) (rsp *models.UePolicySet, err error) {
...
// Path Params: ueId
func UpdateSessionManagementPolicyData(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.SmPolicyDataPatch) (rsp *models.SmPolicyData, err error) {
...
func CreateUsageMonitoringResource(cli sbi.ConsumerClient, ctx context.Context, params CreateUsageMonitoringResourceParams, body *models.UsageMonData) (headers map[string]string, rsp *models.UsageMonData, err error) {
...
func DeleteUsageMonitoringInformation(cli sbi.ConsumerClient, ctx context.Context, params DeleteUsageMonitoringInformationParams) (err error) {
...
// Response headers: Location
func CreateIndividualBdtData(cli sbi.ConsumerClient, ctx context.Context, bdtReferenceId string, body *models.BdtData) (headers map[string]string, rsp *models.BdtData, err error) {
...
// Path Params: subsId
func ReplaceIndividualPolicyDataSubscription(cli sbi.ConsumerClient, ctx context.Context, subsId string, body *models.PolicyDataSubscription) (rsp *models.PolicyDataSubscription, err error) {
...
func ReadPolicyData(cli sbi.ConsumerClient, ctx context.Context, params ReadPolicyDataParams) (rsp *models.PolicyDataForIndividualUe, err error) {
...
func ReadIndividualBdtData(cli sbi.ConsumerClient, ctx context.Context, params ReadIndividualBdtDataParams) (rsp *models.BdtData, err error) {
...
// Path Params: ueId
func ReplaceOperatorSpecificData(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *map[string]models.OperatorSpecificDataContainer) (rsp *map[string]models.OperatorSpecificDataContainer, err error) {
...
// Path: /policy-data/ues/:ueId/operator-specific-data
// Path Params: ueId
func UpdateOperatorSpecificData(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *[]models.PatchItem) (rsp *models.PatchResult, err error) {
...
func ReadOperatorSpecificData(cli sbi.ConsumerClient, ctx context.Context, params ReadOperatorSpecificDataParams) (rsp *map[string]models.OperatorSpecificDataContainer, err error) {
...
func ReadSlicePolicyControlData(cli sbi.ConsumerClient, ctx context.Context, params ReadSlicePolicyControlDataParams) (rsp *models.SlicePolicyData, err error) {
...
// Path: /policy-data/slice-control-data/:snssai
// Path Params: snssai
func UpdateSlicePolicyControlData(cli sbi.ConsumerClient, ctx context.Context, snssai *models.Snssai, body *models.SlicePolicyDataPatch) (rsp *models.SlicePolicyData, err error) {
...
// Path: /policy-data/ues/:ueId/ue-policy-set
// Path Params: ueId
func UpdateUEPolicySet(cli sbi.ConsumerClient, ctx context.Context, ueId string, body *models.UePolicySetPatch) (err error) {
...
func ReadUEPolicySet(cli sbi.ConsumerClient, ctx context.Context, params ReadUEPolicySetParams) (rsp *models.UePolicySet, err error) {
...
func ReadSessionManagementPolicyData(cli sbi.ConsumerClient, ctx context.Context, params ReadSessionManagementPolicyDataParams) (rsp *models.SmPolicyData, err error) {
...
func ReadUsageMonitoringInformation(cli sbi.ConsumerClient, ctx context.Context, params ReadUsageMonitoringInformationParams) (rsp *models.UsageMonData, err error) {
...
func ReadSponsorConnectivityData(cli sbi.ConsumerClient, ctx context.Context, sponsorId string) (rsp *models.SponsorConnectivityData, err error) {
...
func ReadBdtData(cli sbi.ConsumerClient, ctx context.Context, params ReadBdtDataParams) (rsp *[]models.BdtData, err error) {
...
// Path: /policy-data/bdt-data/:bdtReferenceId
// Path Params: bdtReferenceId
func DeleteIndividualBdtData(cli sbi.ConsumerClient, ctx context.Context, bdtReferenceId string) (err error) {
...
// Path: /policy-data/bdt-data/:bdtReferenceId
// Path Params: bdtReferenceId
func UpdateIndividualBdtData(cli sbi.ConsumerClient, ctx context.Context, bdtReferenceId string, body *models.BdtDataPatch) (rsp *models.BdtData, err error) {
...
// Path Params:
// Response headers: Location
func CreateIndividualPolicyDataSubscription(cli sbi.ConsumerClient, ctx context.Context, body *models.PolicyDataSubscription) (headers map[string]string, rsp *models.PolicyDataSubscription, err error) {
...
// Path: /policy-data/subs-to-notify/:subsId
// Path Params: subsId
func DeleteIndividualPolicyDataSubscription(cli sbi.ConsumerClient, ctx context.Context, subsId string) (err error) {
...
// Path: /policy-data/ues/:ueId/operator-specific-data
// Path Params: ueId
func DeleteOperatorSpecificData(cli sbi.ConsumerClient, ctx context.Context, ueId string) (err error) {
...
// Path Params: plmnId
func ReadPlmnUePolicySet(cli sbi.ConsumerClient, ctx context.Context, plmnId string) (rsp *models.UePolicySet, err error) {
...
func GetMBSSessPolCtrlData(cli sbi.ConsumerClient, ctx context.Context, polSessionId *models.MbsSessPolDataId) (rsp *models.MbsSessPolCtrlData, err error) {
	...
	case 200:
		...
		if err = response.DecodeBody(rsp); err != nil {
			err = fmt.Errorf("Fail to decode MbsSessPolCtrlData: %+v", err)
		}
	case 400, 401, 403, 404, 414, 429, 500, 503:
		prob := new(models.ProblemDetails)
		if err = response.DecodeBody(prob); err == nil {
