...
// Path Params:
// Response headers: Location
func CreateIndividualPolicyDataSubscription(cli sbi.ConsumerClient, body *models.PolicyDataSubscription) (headers map[string]string, rsp *models.PolicyDataSubscription, err error) {
