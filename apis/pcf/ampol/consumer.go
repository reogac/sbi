...
func CreateIndividualAMPolicyAssociation(cli sbi.ConsumerClient, ctx context.Context, body *models.PolicyAssociationRequest) (headers map[string]string, rsp *models.PolicyAssociation, err error) {
...
func DeleteIndividualAMPolicyAssociation(cli sbi.ConsumerClient, ctx context.Context, polAssoId string) (err error) {
...
// Path: /policies/:polAssoId
// Path Params: polAssoId
func ReadIndividualAMPolicyAssociation(cli sbi.ConsumerClient, ctx context.Context, polAssoId string) (rsp *models.PolicyAssociation, err error) {
...
// Path Params: polAssoId
func ReportObservedEventTriggersForIndividualAMPolicyAssociation(cli sbi.ConsumerClient, ctx context.Context, polAssoId string, body *models.PolicyAssociationUpdateRequest) (rsp *models.PolicyUpdate, err error) {
