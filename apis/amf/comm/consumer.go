...
func N1N2MessageTransfer(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.N1N2MessageTransferRequest) (rsp *models.N1N2MessageTransferRspData, ersp *models.N1N2MessageTransferError, err error) {
...
func N1N2MessageSubscribe(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.UeN1N2InfoSubscriptionCreateData) (headers map[string]string, rsp *models.UeN1N2InfoSubscriptionCreatedData, err error) {
...
// Path Params:
func NonUeN2MessageTransfer(cli sbi.ConsumerClient, ctx context.Context, body *models.NonUeN2MessageTransferRequest) (rsp *models.N2InformationTransferRspData, ersp *models.N2InformationTransferError, err error) {
...
// Path Params: ueContextId
func RegistrationStatusUpdate(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.UeRegStatusUpdateReqData) (rsp *models.UeRegStatusUpdateRspData, err error) {
...
func NonUeN2InfoUnSubscribe(cli sbi.ConsumerClient, ctx context.Context, n2NotifySubscriptionId string) (err error) {
...
// Path Params: ueContextId
func EBIAssignment(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.AssignEbiData) (rsp *models.AssignedEbiData, ersp *models.AssignEbiError, err error) {
...
// Path Params: ueContextId
func CancelRelocateUEContext(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.CancelRelocateUEContextRequest) (err error) {
...
func N1N2MessageUnSubscribe(cli sbi.ConsumerClient, ctx context.Context, params N1N2MessageUnSubscribeParams) (err error) {
...
// Path Params:
// Response headers: Location
func NonUeN2InfoSubscribe(cli sbi.ConsumerClient, ctx context.Context, body *models.NonUeN2InfoSubscriptionCreateData) (headers map[string]string, rsp *models.NonUeN2InfoSubscriptionCreatedData, err error) {
...
// Path Params: ueContextId
func ReleaseUEContext(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.UEContextRelease) (err error) {
...
// Path Params:
// Response headers: Location
func AMFStatusChangeSubscribe(cli sbi.ConsumerClient, ctx context.Context, body *models.SubscriptionData) (headers map[string]string, rsp *models.SubscriptionData, err error) {
...
func AMFStatusChangeSubscribeModfy(cli sbi.ConsumerClient, ctx context.Context, subscriptionId string, body *models.SubscriptionData) (rsp *models.SubscriptionData, err error) {
...
// Path: /subscriptions/:subscriptionId
// Path Params: subscriptionId
func AMFStatusChangeUnSubscribe(cli sbi.ConsumerClient, ctx context.Context, subscriptionId string) (err error) {
...
func CreateUEContext(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.CreateUEContextRequest) (headers map[string]string, rsp *models.CreateUEContextResponse, ersp *models.UeContextCreateError, err error) {
...
// Path Params: ueContextId
func UEContextTransfer(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.UEContextTransferRequest) (rsp *models.UEContextTransferResponse, err error) {
...
// Path Params: ueContextId
// Response headers: Location
func RelocateUEContext(cli sbi.ConsumerClient, ctx context.Context, ueContextId string, body *models.RelocateUEContextRequest) (headers map[string]string, rsp *models.UeContextRelocatedData, err error) {
