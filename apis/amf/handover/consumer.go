...
// Path: /require/:ueId
// Path Params: ueId
func HandoverRequire(cli sbi.ConsumerClient, ueId int64, body *models.HandoverRequire) (rsp *models.HandoverCommand, ersp *models.HandoverPreparationFailure, err error) {
