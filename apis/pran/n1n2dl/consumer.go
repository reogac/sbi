...
// Path: /n2/:ueId
// Path Params: ueId
func N2SmInfoDownlink(cli sbi.ConsumerClient, ctx context.Context, ueId int64, body *models.N2SmInfoDownlinkTransport) (err error) {
...
// Path Params: ueId
func SessionResourceSetup(cli sbi.ConsumerClient, ctx context.Context, ueId int64, body *models.SessionResourceSetupRequest) (rsp *models.SessionResourceSetupResponse, err error) {
...
// Path Params: ueId
func SessionResourceModify(cli sbi.ConsumerClient, ctx context.Context, ueId int64, body *models.SessionResourceModifyRequest) (rsp *models.SessionResourceModifyResponse, err error) {
...
// Path Params: ueId
func SessionResourceRelease(cli sbi.ConsumerClient, ctx context.Context, ueId int64, body *models.SessionResourceReleaseRequest) (rsp *models.SessionResourceReleaseResponse, err error) {
