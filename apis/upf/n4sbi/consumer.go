...
// Path: /associate
// Path Params:
func AssociationRequest(cli sbi.ConsumerClient, ctx context.Context, callback *models.EndpointInfo, body *message.PFCPAssociationSetupRequest) (rsp *message.PFCPAssociationSetupResponse, err error) {
...
// Path Params: smfId
func DisassociationRequest(cli sbi.ConsumerClient, ctx context.Context, smfId string) (err error) {
...
// Path Params: smfId
func SessionEstablishment(cli sbi.ConsumerClient, ctx context.Context, smfId string, body *message.PFCPSessionEstablishmentRequest) (rsp *message.PFCPSessionEstablishmentResponse, err error) {
...
// Path Params: seid
func SessionModification(cli sbi.ConsumerClient, ctx context.Context, seid int64, body *message.PFCPSessionModificationRequest) (rsp *message.PFCPSessionModificationResponse, err error) {
...
// Path Params: seid
func SessionDeletion(cli sbi.ConsumerClient, ctx context.Context, seid int64, body *message.PFCPSessionDeletionRequest) (rsp *message.PFCPSessionDeletionResponse, err error) {
